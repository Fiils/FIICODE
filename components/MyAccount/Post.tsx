                ...
                <div className={styles.image}>
                    ...
                    {!media[0] && 
                        <div style={{ display: 'flex', flexFlow: 'column wrap', justifyContent: 'center', height: '100%', position: 'relative', alignItems: 'center', border: '1px solid rgb(130, 130, 130)', borderRadius: 2 }}>
                                <Image src='https://res.cloudinary.com/multimediarog/image/upload/v1647938098/FIICODE/no-image-6663_bwocug.svg' height={40} width={40} alt='Fara Poze' />
                        ...
                        <div key={'a' + _id} className={styles.manip_section}>
                            <Link href={`/postari/${_id}`}>
                                <div className={styles.manip_item}>
                                    <Image src='https://res.cloudinary.com/multimediarog/image/upload/v1648474271/FIICODE/hearts-7890_2_maukcl.svg' alt='Reactii' width={20} height={20} />
