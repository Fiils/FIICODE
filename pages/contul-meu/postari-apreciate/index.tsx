                ...
                <div className={gridStyles.container_options}>
                    ...
                    <>  
                        <div className={styles.title}>
                            <Image src='https://res.cloudinary.com/multimediarog/image/upload/v1648561628/FIICODE/folder-and-heart-11496_bybyn1.svg' alt='Icon' width={!isVerySmallScreen ? 50 : 35} height={!isVerySmallScreen ? 50 : 35} priority/>
                            <h1>
                                Postări apreciate
                            </h1>
                        </div>
                            <div style={{ display: 'flex', flexFlow: 'column wrap', gap: '5em'}}>
                                {iterations.map((value: any, i: number) => {
                                    ...
                                    profilePicture={likedPosts.posts[i].profilePicture} i={i}  />
                                })}
                            </div>
